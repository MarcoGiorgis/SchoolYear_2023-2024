...
public class EsempioFileNoEccezioni {
    public static void main(String[] args) throws IOException {
        ...
        //FileWriter fw = new FileWriter(nomeFile, false); sinonimo
        ...
        //apertura in APPEND in scrittura
        //il costruttore FileWriter ha anche il secondo parametro append se true il file è scritto in append
        //altrimenti no se è false
        ...
        /////////////LETTURA PER RIGHE//////////////
        //dal file si crea un FileReader e successivamente il BufferedReader per leggere il file
        ...
        int cod = br.read();    //return codice UNICODE, legge un carattere alla volta
         ...
         */
        nomeFile = "nuovo.txt";
        File f = new File(nomeFile); //non è veramente creato si crea solamente il riferimento
